...
namespace RestWithASPNET5Udemy.Business.Implementation
{
    public class LoginBusinessImplementation : ILoginBusiness
    {
        ...
        public TokenVO ValidateCredentials(UserVO userCreditials)
        {
            var user = _repository.ValidateCreditials(userCreditials);
        ...
        public TokenVO ValidateCredentials(TokenVO token)
        {
            ...
            var user = _repository.ValidateCreditials(userName);
