                ...
                {books.map(book =>(
                    <li key={book.id}>
                        ...
                        <button onClick={() => editBook(book.id)} type="button">
                            <FiEdit size={20} color="#251DC5" />
                        </button>
                        
                        <button onClick={() => deleteBook(book.id)} type="button">
                            <FiTrash2 size={20} color="#251DC5" />
                        </button>
                    </li>
                ))}                
            </ul>
            <button className="button" onClick={fetcMoreBooks} type="button">Load More</button>
